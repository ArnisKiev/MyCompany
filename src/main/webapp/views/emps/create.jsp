  	...
  	<body>
		...
		<main class="container">
		  	<div class="bg-light p-5 rounded text-center main-box">
		    	...
		    	<!-- ////////////////////// Content Placeholder ///////////////////// -->	
		    		<h2>Додання нового співробітника</h2>
		    		<form id="empForm" action="emps?page=create" method="post">
		    			<div class="form-group">
		    				<label>Ім'я співробітника:</label>
		    				<input type="text" name="empFullName" class="form-control" required>
		    			</div>
